...
export abstract class NotificacaoReadRepository {
  ...
  abstract findUnidadeById(id: string): Promise<UnidadeSaude | null>;
  abstract findCasos(
    clienteId: string,
    filters?: { status?: string; regiaoId?: string },
  ): Promise<CasoNotificado[]>;
  abstract findCasoById(id: string): Promise<CasoNotificado | null>;
  ...
  abstract findEsusById(id: string): Promise<ItemNotificacaoEsus | null>;
