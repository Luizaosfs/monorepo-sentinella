...
export function ModalDesenharQuarteirao({ open, regioes, bairroIdInicial, onClose, onSalvo }: Props) {
  ...
  return (
    <Dialog open={open} onOpenChange={(v) => !v && handleClose()}>
      <DialogContent className="w-[calc(100vw-16px)] h-[calc(100vh-16px)] max-w-none p-0 flex flex-col gap-0 overflow-hidden">
        ...
        <div className="flex-1 min-h-0 overflow-y-auto px-6 pt-3 pb-4 space-y-3">
          ...
          {etapa === 'desenho' && (
            <>
              ...
              {/* Mapa */}
              <Suspense fallback={
                <div className="h-[calc(100vh-300px)] min-h-[320px] rounded-lg border bg-muted/30 flex items-center justify-center gap-2 text-xs text-muted-foreground">
                ...
                <DrawPolygonMap
                  ...
                  mapClassName="h-[calc(100vh-300px)] min-h-[320px]"
                />
              </Suspense>
            </>
          )}
          ...
          {etapa === 'preview' && (
            <div className="space-y-3">
              ...
              {/* Mapa preview */}
              <Suspense fallback={
                <div className="h-[calc(100vh-420px)] min-h-[260px] rounded-lg border bg-muted/30 flex items-center justify-center gap-2 text-xs text-muted-foreground">
