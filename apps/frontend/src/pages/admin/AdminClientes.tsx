...
const AdminClientes = () => {
  ...
  const handleSave = () => {
    ...
    const payload = {
      ...
      contatoEmail: form.contato_email.trim() || undefined,
      contatoTelefone: form.contato_telefone.trim() || undefined,
      ...
      ibgeMunicipio: ibge || undefined,
      latitudeCentro: form.latitude_centro ? parseFloat(form.latitude_centro) : undefined,
      longitudeCentro: form.longitude_centro ? parseFloat(form.longitude_centro) : undefined,
      bounds: parsedBounds ?? undefined,
      area: form.area || undefined,
      ativo: form.ativo,
      surtoAtivo: form.surto_ativo,
    };
    saveMutation.mutate({
      data: payload,
