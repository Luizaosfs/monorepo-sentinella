-- Corrige v_focos_risco_ativos: restaura origem_image_url e origem_item
-- perdidos na migration 20261003000000_dados_minimos (DROP/CREATE sem o JOIN li).
-- Usa DROP CASCADE para evitar conflito de ordem de colunas com CREATE OR REPLACE.
...
COMMENT ON VIEW v_focos_risco_ativos IS
  ...
  'image_url e item do levantamento de origem (origem_image_url, origem_item). '
