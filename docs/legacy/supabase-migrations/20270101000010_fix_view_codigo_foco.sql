-- Recria v_focos_risco_ativos e v_focos_risco_todos para incluir
-- a coluna codigo_foco adicionada em 20270101000001_p0_codigo_foco.sql.
-- SELECT fr.* em views PostgreSQL não captura colunas adicionadas após a criação.

-- ── v_focos_risco_ativos ───────────────────────────────────────────────────────
...
COMMENT ON VIEW v_focos_risco_ativos IS
  ...
  'Inclui codigo_foco (adicionado em 20270101000001). '
