-- Corrige create_vistoria_completa: adiciona cliente_id no INSERT de vistoria_depositos
-- Causa do erro: "null value in column cliente_id of relation vistoria_depositos"
...
BEGIN
  ...
  -- 2. Depósitos — inclui cliente_id (NOT NULL na tabela)
  FOR v_deposito IN
  ...
  IF COALESCE((p_payload->>'tem_calha')::boolean, false)
     AND p_payload->>'imovel_id' IS NOT NULL THEN
    UPDATE imoveis
    SET
      tem_calha       = true,
